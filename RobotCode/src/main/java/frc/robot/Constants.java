...
*/
    ...
    public final static class CoordsTags2and7{
        ...
        public static final double[] PlatformWayPoint = {4.700, -0.200, 0}; //Before x = 4.6 3/18/23 1:00 PM
...
public static double[][] BlueScoreTag3and6North = {
  ...
  //  public static final int rotateClawMotorPort = 21;
    ...
    public static final double minAngleEncoderValue = -17; //Before -14.0 3/16/23
